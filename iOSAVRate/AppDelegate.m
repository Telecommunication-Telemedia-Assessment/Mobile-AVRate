...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    if(settings != NULL) {
        Settings *gSettings = [Settings get];
        gSettings.ipServer = settings.ipServer;
        gSettings.xmlViewSettings = settings.xmlViewSettings;
        gSettings.standalone = settings.standalone;
        gSettings.trainingList = settings.trainingList;
        gSettings.selectedPlaylist = settings.selectedPlaylist;
    }
